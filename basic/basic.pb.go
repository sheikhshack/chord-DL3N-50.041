...
var file_basic_proto_rawDesc = []byte{
	...
	,
...
var file_basic_proto_goTypes = []interface{}{
	(*Message)(nil), // 0: basic.Message
}
var file_basic_proto_depIdxs = []int32{
	0, // 0: basic.BasicService.SayHello:input_type -> basic.Message
	0, // 1: basic.BasicService.SayHello:output_type -> basic.Message
...
func (c *basicServiceClient) SayHello(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/basic.BasicService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedBasicServiceServer) SayHello(context.Context, *Message) (*Message, error) {
...
func _BasicService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/basic.BasicService/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BasicServiceServer).SayHello(ctx, req.(*Message))
	}
